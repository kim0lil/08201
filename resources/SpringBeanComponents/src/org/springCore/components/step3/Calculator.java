package org.springCore.components.step3;
...
public class Calculator {
	...
	/** updated -> Class to use calculation function : (new HistoryCalculation()) or (new SimpleCalculation())*/
	private Calculation calculation = new SimpleCalculation();
