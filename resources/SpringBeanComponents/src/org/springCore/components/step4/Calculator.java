...
public class Calculator {
	...
	/** updated -> Class to use calculation function : not Choice */
	private Calculation calculation;
	
	/** input-stream to receive input : accepts standard console input of System */
	private Scanner input;

	/** updated -> Dependencies are externally injected */
	...
	public static void main(String[] args) {
		Calculator calculator = ApplicationFactory.getCalculator();
		calculator.on();
		calculator.off();
	}
